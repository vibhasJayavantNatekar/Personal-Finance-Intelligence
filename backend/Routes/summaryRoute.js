...
const {getDashboardSummary, expenseAnalytics, expenseAllocation, loanAllocation, emiAnalysis, investmentAnalytics, investmentPerformance, investmentAllocation, loanAnalytics, getHolding, investmentInsights, loanInsights, expensesInsights, expenseCalendar, stocksHolding} = require('../Controller/summaryController')
...
router.get("/emianalysis",requireAuth,emiAnalysis)
