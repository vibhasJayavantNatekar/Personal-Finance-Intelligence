                ...
                <div className="sip_workspace">
                  ...
                  <div className="calculator_results">
                    ...
                    <div className="calculator_chart">
                      ...
                      <div className="growth_chart_wrapper">


                        {/* Y AXIS */}

                        <div className="growth_y_axis">
                        ...
                        <div className="growth_chart">
                          ...
                          <div className="growth_points">



                            <div className="growth_point" style={{ bottom: "10%" }}>
                              <span>1Y</span>
                            </div>



                            <div className="growth_point" style={{ bottom: "25%" }}>
                              <span>3Y</span>
                            </div>



                            <div className="growth_point" style={{ bottom: "42%" }}>
                              <span>5Y</span>
                            </div>



                            <div className="growth_point" style={{ bottom: "60%" }}>
                              <span>7Y</span>
                            </div>



                            <div className="growth_point" style={{ bottom: "78%" }}>
                              <span>10Y</span>
                            </div>
